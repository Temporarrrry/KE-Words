...
export const ButtonLayout = styled.button<ButtonLayoutProps>`
  ...
  ${({ buttonType, color }) => {
    switch (buttonType) {
      case "bg":
        if (color === "blue") return blueBgButtonStyles;
        else return pinkBgButtonStyles;
      case "border":
        if (color === "blue") return blueBorderedButtonStyles;
        else return pinkBorderedButtonStyles;
      default:
